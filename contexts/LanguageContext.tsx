...
const translations = {
  vi: {
    nav: {
      ...
      getStarted: 'Đăng ký nhận thông báo khi ra mắt',
    },
    earlyAccess: {
      modalTitle: 'Đăng ký nhận thông báo',
      modalTitleHighlight: 'khi ra mắt',
      modalSubtitle: 'Chúng tôi sẽ gửi thông báo cho bạn ngay khi Dropease sẵn sàng — cùng ưu đãi đặc biệt cho người đăng ký sớm.',
      emailLabel: 'Email',
      emailPlaceholder: 'your@email.com',
      nameLabel: 'Tên của bạn',
      namePlaceholder: 'Nguyễn Văn A',
      roleLabel: 'Bạn là ai?',
      rolePlaceholder: 'Chọn vai trò của bạn',
      roleOptions: {
        storeOwner: 'Chủ cửa hàng nhỏ / cá nhân',
        marketer: 'Marketer / Quản lý sản phẩm',
        dropshipper: 'Dropshipper',
        agency: 'Agency / Công ty',
        other: 'Khác',
      },
      shopifyStoreLabel: 'Link cửa hàng Shopify (nếu có)',
      shopifyStorePlaceholder: 'https://yourstore.myshopify.com',
      referralLabel: 'Bạn biết đến Dropease từ đâu?',
      referralPlaceholder: 'Chọn nguồn',
      referralOptions: {
        google: 'Google Search',
        aiSearch: 'AI Search (ChatGPT, Gemini, Claude...)',
        facebook: 'Facebook',
        linkedin: 'LinkedIn',
        youtube: 'YouTube',
      ...
      otherSourceLabel: 'Nguồn khác (vui lòng nêu rõ)',
      otherSourcePlaceholder: 'Nêu rõ nguồn...',
      optInLabel: 'Tôi đồng ý nhận cập nhật sản phẩm & ưu đãi từ Dropease.',
      submitButton: 'Đăng ký nhận thông báo',
      submitting: 'Đang gửi...',
      submitSuccess: 'Đăng ký thành công!',
      successMessage: '🎉 Cảm ơn bạn! Chúng tôi sẽ liên hệ sớm nhất khi Dropease ra mắt.',
  ...
  en: {
    nav: {
      ...
      getStarted: 'Get Notified at Launch',
    },
    earlyAccess: {
      modalTitle: 'Get Notified',
      modalTitleHighlight: 'at Launch',
      modalSubtitle: "We'll notify you as soon as Dropease is ready — plus exclusive offers for early subscribers.",
      emailLabel: 'Email',
      emailPlaceholder: 'your@email.com',
      nameLabel: 'Your Name',
      ...
      roleOptions: {
        storeOwner: 'Small store owner / Individual',
        marketer: 'Marketer / Product Manager',
        dropshipper: 'Dropshipper',
        agency: 'Agency / Company',
        other: 'Other',
      },
      shopifyStoreLabel: 'Shopify Store Link (optional)',
      shopifyStorePlaceholder: 'https://yourstore.myshopify.com',
      referralLabel: 'How did you hear about Dropease?',
      ...
      otherSourceLabel: 'Other source (please specify)',
      otherSourcePlaceholder: 'Specify source...',
      optInLabel: 'I agree to receive product updates & offers from Dropease.',
      submitButton: 'Get Notified at Launch',
      submitting: 'Submitting...',
      submitSuccess: 'Successfully registered!',
      successMessage: "🎉 Thank you! We'll contact you as soon as Dropease launches.",
